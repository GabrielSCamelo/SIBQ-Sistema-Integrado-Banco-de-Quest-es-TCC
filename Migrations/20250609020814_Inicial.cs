        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriadorId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "Simulado_Aluno_Resposta",
                columns: table => new
                {
                    SimuladoAlunoId = table.Column<int>(type: "int", nullable: false),
                    QuestaoId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false),
                    SimuladoAlunoSimuladoId = table.Column<int>(type: "int", nullable: false),
                    SimuladoAlunoAlunoId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Resposta = table.Column<string>(type: "varchar(1)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Simulado_Aluno_Resposta", x => new { x.QuestaoId, x.SimuladoAlunoId });
                    table.ForeignKey(
                        name: "FK_Simulado_Aluno_Resposta_Questoes_QuestaoId",
                        column: x => x.QuestaoId,
                        principalTable: "Questoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Simulado_Aluno_Resposta_Simulados_Alunos_SimuladoAlunoSimula~",
                        columns: x => new { x.SimuladoAlunoSimuladoId, x.SimuladoAlunoAlunoId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Simulado_Aluno_Resposta_SimuladoAlunoSimuladoId_SimuladoAlun~",
                table: "Simulado_Aluno_Resposta",
                columns: new[] { "SimuladoAlunoSimuladoId", "SimuladoAlunoAlunoId" });
